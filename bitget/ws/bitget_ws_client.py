...
class BitgetWsClient:
    ...
    def connect(self):
        try:
            self.__ws_client.run_forever(ping_timeout=10, http_proxy_host='127.0.0.1', http_proxy_port="1087",
                                         proxy_type="http",
...
class BooksInfo:
    ...
    def check_sum(self, new_check_sum):
        ...
        print("start checknum mergeVal:" + str(merge_num) + ",checkVal:" + str(new_check_sum) + ",checkSin:" + str(
            self.__signed_int(merge_num)))
